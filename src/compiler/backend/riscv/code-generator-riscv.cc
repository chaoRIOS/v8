...
#undef ATOMIC_BINOP_CASE
    case kRiscvWord32AtomicPairLoad:{
      Register second_output = instr->OutputCount() == 2
                                       ? i.OutputRegister(1)
                                       : i.TempRegister(1);
      __ Ll(second_output, MemOperand(i.InputRegister(0), 4));
      __ Ll(i.OutputRegister(0), MemOperand(i.InputRegister(0), 0));
      __ sync();
      break;
    }
    ...
    case kRiscvWord32AtomicPairStore:{
      ...
      __ sync();
      __ bind(&store);
      __ Ll(i.TempRegister(2), MemOperand(i.InputRegister(0), 4));
      __ Ll(i.TempRegister(1), MemOperand(i.InputRegister(0), 0));
      __ Move(i.TempRegister(1), i.InputRegister(2));
      __ Sc(i.InputRegister(3), MemOperand(i.InputRegister(0), 4));
      __ Sc(i.TempRegister(1), MemOperand(i.InputRegister(0), 0));
      __ BranchShort(&store, ne, i.TempRegister(1), Operand(zero_reg));
      __ sync();
      break;
    }
    ...
    case kRiscvWord32AtomicPairAdd:{                      
      do {
        ...
        __ sync();                                                               
        __ bind(&binop);                                                         
        __ Ll(oldval_low, MemOperand(i.InputRegister(0), 0));                     
        __ Ll(oldval_high, MemOperand(i.InputRegister(0), 4));                   
        __ add(i.TempRegister(1), oldval_low, i.InputRegister(2));
        __ sltu(kScratchReg, i.TempRegister(1), oldval_low);
        __ add(i.TempRegister(2), oldval_high, i.InputRegister(3));
        __ add(i.TempRegister(2), i.TempRegister(2), kScratchReg);
        __ Sc(i.TempRegister(2), MemOperand(i.InputRegister(0), 4));             
        __ Sc(i.TempRegister(1), MemOperand(i.InputRegister(0), 0));              
    ...
    case kRiscvWord32AtomicPairSub:{                      
      do {
        ...
        __ Ll(oldval_low, MemOperand(i.InputRegister(0), 0));                     
        __ Ll(oldval_high, MemOperand(i.InputRegister(0), 4));                   
        __ sub(i.TempRegister(1), oldval_low, i.InputRegister(2));
        __ sltu(kScratchReg, oldval_low, i.TempRegister(1));
        __ sub(i.TempRegister(2), oldval_high, i.InputRegister(3));
        __ sub(i.TempRegister(2), i.TempRegister(2), kScratchReg);
        __ Sc(i.TempRegister(2), MemOperand(i.InputRegister(0), 4));             
        __ Sc(i.TempRegister(1), MemOperand(i.InputRegister(0), 0));              
        __ BranchShort(&binop, ne, i.TempRegister(1), Operand(zero_reg));        
        __ sync();
...
#define ATOMIC64_BINOP_LOGIC_CASE(op, bin_instr) \
  case kRiscvWord32AtomicPair##op: {                     \
    do {\
      ...
      __ sync();                                                               \
      __ bind(&binop);                                                         \
      __ Ll(oldval_high, MemOperand(i.TempRegister(0), 4));                   \
      __ Ll(oldval_low, MemOperand(i.TempRegister(0), 0));                     \
      __ bin_instr(i.TempRegister(1), oldval_low, i.InputRegister(2)); \
      __ bin_instr(i.TempRegister(2), oldval_high, i.InputRegister(3));  \
      __ Sc(i.TempRegister(2), MemOperand(i.TempRegister(0), 4));             \
    ...
    ATOMIC64_BINOP_LOGIC_CASE(And, And)
    ATOMIC64_BINOP_LOGIC_CASE(Or, Or)
    ATOMIC64_BINOP_LOGIC_CASE(Xor, Xor)
#undef ATOMIC64_BINOP_LOGIC_CASE
    ...
    case kRiscvWord32AtomicPairExchange:{
      ...
      __ Ll(oldval_low, MemOperand(i.TempRegister(0), 0));
      __ Move(i.TempRegister(1), i.InputRegister(2));
      __ Sc(i.InputRegister(3), MemOperand(i.TempRegister(0), 4));
      __ Sc(i.TempRegister(1), MemOperand(i.TempRegister(0), 0));
      __ BranchShort(&binop, eq, i.TempRegister(1), Operand(zero_reg));
      __ sync();
    ...
    case kRiscvWord32AtomicPairCompareExchange: {
      ...
      __ Move(kScratchReg, i.InputRegister(4));
      __ Sc(i.InputRegister(5), MemOperand(i.TempRegister(0), 4));
